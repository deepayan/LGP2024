...
- But it also has real-life applications
...
- This is not an easy task — but mathematics can help!
...
- See some simple examples of what data can look like

- See how mathematics can help us to understand data
...
- Popular data analysis software: Excel, R, Python

- We will focus on R, which has some interesting features
...
- Tutorial: Use R to solve problems
...
- Tomorrow:
	...
	- Make sure you have filled up [the survey](https://forms.gle/Up2tUATuSoBNMuvX6)
...
- In mathematical terms, the problem is to find a pair of integers $(m, n)$ such that $50 < n < 500$ and
  $$
...
* We have already seen several examples (`choose`, `log`)
...
* More more details, try running `help(sample)`
...
- Remember, we want to calculate
  $$p(80) = \left(1 - \frac{1}{365} \right) \left(1 - \frac{2}{365} \right) \dotsm \left(1 - \frac{79}{365} \right)$$
...
* I have omitted many details, which I hope will we can clarify in the tutorials
...
* Tutorial:
	...
	- Recreate what we have done in R
	
	- Write an R function to find the aliquot sum of a number
	
	- Use it to find a new perfect number
